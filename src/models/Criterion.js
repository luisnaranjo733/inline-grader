class Criterion {
    constructor(name, description, pointsPossible, sectionPath) {
        if (!name || !description || !pointsPossible || !sectionPath) {
            throw 'Criterion constructor expects name, description, and pointsPossible as parameters';
        }
       ...
       if (!Array.isArray(sectionPath)) {
           ...
           sectionPath.forEach(fuction(section) {
    ...
    get rootSection() {
        return this.sectionPath.length > 0 ? sectionPath[0] : ''
    }
